...
# Get path of sals data CSV file from the command line
def get_sales_csv():

    # Check wether command line parameter provided
    num_params = len(argv) - 1
    if num_params >= 1:
        sales_csv = argv[1]
        # check whether provided parameter is vaild path of file
...
# Create the directory to hold the individual orcer of Excel sheets
def create_orders_dir(sales_csv):
    ...
    # Create the order directory if it does not aldready exist
